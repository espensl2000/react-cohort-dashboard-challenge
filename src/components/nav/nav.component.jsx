    ...
    return (
        ...
        <div className="nav-wrapper">
            ...
            <div className="nav-content">
                ...
                <button onClick={() => navigate("/")} className={path === "/" ? "nav-content-option-selected" : "nav-content-option"}>
                ...
                <button onClick={() => navigate("/profile")} className={path === "/profile" ? "nav-content-option-selected" : "nav-content-option"}>
                <svg
                    width="41"
                    height="40"
                    viewBox="0 0 41 40"
